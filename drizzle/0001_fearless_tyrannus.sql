...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "orgMembershipRequests" (
	"userId" text NOT NULL,
	"orgId" varchar(50) NOT NULL,
	CONSTRAINT "orgMembershipRequests_userId_orgId_pk" PRIMARY KEY("userId","orgId")
);
--> statement-breakpoint
...
DO $$ BEGIN
 ALTER TABLE "orgMembershipRequests" ADD CONSTRAINT "orgMembershipRequests_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "orgMembershipRequests" ADD CONSTRAINT "orgMembershipRequests_orgId_orgs_id_fk" FOREIGN KEY ("orgId") REFERENCES "orgs"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
